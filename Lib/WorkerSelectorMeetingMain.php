...
class WorkerSelectorMeetingMain extends WorkerBase
{
    protected SelectorMeetingMain $templateMain;
    ...
    {
        $this->templateMain = new SelectorMeetingMain();
...
$workerClassname = WorkerSelectorMeetingMain::class;
