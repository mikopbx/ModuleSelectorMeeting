...
class ModuleSelectorMeeting extends ModulesModelsBase
{
     ...
     *
     * There is example to describe the relation between Providers and ModuleSelectorMeeting models
     *
...
//                'id',
//                ModuleSelectorMeeting::class,
//                'dropdown_field',
//                [
//                    'alias'      => 'ModuleSelectorMeetingProvider',
//                    'foreignKey' => [
//                        'allowNulls' => 0,
//                        'message'    => 'Models\ModuleSelectorMeetingProvider',
...
//        }
    ...
    {
        $this->setSource('m_ModuleSelectorMeeting');
        $this->hasOne(
            'dropdown_field',
            Providers::class,
            'id',
